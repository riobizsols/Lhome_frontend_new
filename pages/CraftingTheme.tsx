...
import css from "../styles/Craftingtheme.module.scss";
import Footer from "./components/Footer/Footer";
import Warranty from "./components/warranty/Warranty";
import { simpleCallInitAPI } from "../services/ApicallInit";
import CraftingThemeBanner from "./components/CraftingTheme/CraftingTheme";

const CraftingTheme: React.FC = () => {
    const living = React.useRef(null);
    const [Craftingpoints, setPoints] = React.useState([]);
    const [Craftingheading, setHeadings] = React.useState();
    ...
    React.useEffect(() => {
        ...
        api.then((data: any) => {
            let colorplay = [];
            console.log(data.data.desginJournalRows.Theme.points)
            ...
            setHeadings(data.data.desginJournalRows.Theme.boldHeading);
            setsummary(data.data.desginJournalRows.Theme.summary);
